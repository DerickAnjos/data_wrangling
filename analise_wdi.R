...
dataset_wdi <- dataset_wdi %>% rename(pais = 'Country Name',
                                      cod_pais=2,
                                      serie=3,
                                      cod_serie=4,
                                      ano_2019=5,
...
# saude_topicos <- dataset_wdi[str_detect(dataset_wdi$topico, string = '^Health'),
                             'topico']
...
glimpse(dataset_wdi_saude)

# Pode ser útil manter os tópicos de cada variável, por exemplo:
dataset_wdi_final <- pivot_wider(dataset_wdi_saude, 
                                 id_cols = c('pais', 'cod_pais'),
...
dataset_wdi_saude_final <- dataset_wdi_final %>% 
